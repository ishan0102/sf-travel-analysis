...
sf_res = sf_res[(sf_res['*RESPNUM']) | (sf_res['CRSHRE'] != 0.0) | (sf_res['TNC'] != 0.0)]    
...
outside_sf_res = outside_sf_res[(sf_res['*RESPNUM']) | (outside_sf_res['CRSHRE1'] != 0.0) | (outside_sf_res['TNC1'] != 0.0)]
...
resp_nums = sf_res['*RESPNUM'].tolist() + outside_sf_res['*RESPNUM'].tolist()
